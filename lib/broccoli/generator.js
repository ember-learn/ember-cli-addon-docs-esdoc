...
module.exports = class DocsGenerator extends CachingWriter {
  constructor(inputNodes, options) {
    ...
    super([].concat(inputNodes, options.packageTrees), Object.assign(defaults, options));

    this.packageTrees = options.packageTrees;
  ...
  build() {
    ...
    let json = generateESDocJsonApi(this.inputPaths[0], project, this.inputPaths[1]);
